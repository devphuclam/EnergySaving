...
- Baseline HEAD: `9b3fee82d75772dd738dd324d2a50e7b96a03d59`
...
| T039 | RUNNABLE_NOW | PASS | `tests/Unit/Catalog/SourceMappingTests.cs`; focused executable exit 0 | UTC/interval, half-open overlap, Missing/Multiple, deletion decisions |
| T040 | RUNNABLE_NOW | PASS | `tests/Unit/Catalog/CatalogCommandTests.cs`; focused executable exit 0 | Role/scope denial, NotFound, approved owner event envelope |
...
| T043 | RUNNABLE_NOW | PASS | `CatalogEligibilityContracts.cs`; Debug/Release build exit 0 | Metric/Unit outcome and Mapping Missing/Multiple/Eligible snapshots |
| T044 | RUNNABLE_NOW | PASS | `FakeCatalogRepositories.cs`; focused executable exit 0 | Deep rollback, uniqueness, overlap, dependency, version conflict |
...
| T046 | RUNNABLE_NOW | PASS | `SourceMappingModel.cs`; focused executable exit 0 | Source/Mapping lifecycle, UTC effective periods, overlap semantics, terminal states |
| T047 | RUNNABLE_NOW | PASS | `CatalogCommands.cs`; focused executable exit 0 | Trusted role/scope seam, transaction boundaries, safe `.v1` owner events |
...
| T049 | RUNNABLE_NOW | PASS | `CatalogRepositoryTests.cs` linked in `IUMP.Tests.Unit.csproj`; focused executable exit 0 | Executable adapter-agnostic provider/factory contract runner; no Skip/fallback/credentials |
...
| `dotnet run --project .\tests\Unit\IUMP.Tests.Unit.csproj --no-restore -c Debug --no-build` | 0 | 0 failures (`PASS: all tests`) |
...
Allowed Phase 2 files changed: `database/migrations/0003_catalog_foundation.sql`,
...
`tests/Unit/Catalog/MetricUnitTests.cs`, `tests/Unit/Catalog/SourceMappingTests.cs`,
`tests/Unit/Catalog/CatalogCommandTests.cs`, `tests/Unit/Fakes/FakeCatalogRepositories.cs`,
`tests/Integration/Catalog/CatalogRepositoryTests.cs`, `tests/Unit/Program.cs`,
`tests/Unit/IUMP.Tests.Unit.csproj`, this checkpoint, `phase-02-red.md`, and `phase-02-review.md`.
