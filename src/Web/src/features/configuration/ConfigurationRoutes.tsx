...
const empty: ConfigurationSummary = { state: 'loading', siteCount: 0, areaCount: 0, pointCount: 0, metricCount: 0, unitCount: 0, sourceCount: 0, mappingCount: 0, configurationCount: 0, hierarchy: 'Loading', catalog: 'Loading', sources: 'Loading', mappings: 'Loading', activation: 'Loading' }
