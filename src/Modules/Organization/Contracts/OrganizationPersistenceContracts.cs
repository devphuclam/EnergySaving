...
public interface IOrganizationCommandRepository
{
    ...
    Task<OrganizationTargetScope?> GetAreaScopeAsync(AreaId id, CancellationToken ct = default);
    ...
    Task<OrganizationTargetScope?> GetAssetScopeAsync(AssetId id, CancellationToken ct = default);
...
public sealed record OrganizationTargetScope(Guid SiteId, Guid? AreaId = null, Guid? AssetId = null);
