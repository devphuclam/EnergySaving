...
public static class PostgresModuleRegistration
{
        ...
        PostgresRuntimeConfiguration configuration)
    {
        ...
        services.AddScoped<IOperationalWorkspaceCommandPort>(provider =>
            provider.GetRequiredService<PostgresOperationalWorkspacePorts>());
        services.AddScoped<PostgresOperationalDashboardPorts>();
        services.AddScoped<IOperationalDashboardQueryPort>(provider =>
            provider.GetRequiredService<PostgresOperationalDashboardPorts>());
        ...
        services.AddScoped<ISimulatorCommandPort>(provider =>
            provider.GetRequiredService<PostgresSimulatorCommandPort>());
        services.AddScoped<ISimulatorSelectedStartCommandPort>(provider =>
            provider.GetRequiredService<PostgresSimulatorCommandPort>());
        services.AddScoped<ISimulatorQueryPort, PostgresSimulatorQueryPort>();
        services.AddScoped<ISimulatorWorkspaceCommandPort, PostgresSimulatorWorkspaceCommandPort>();
        services.AddScoped<ITelemetryWorkspaceQueryPort, PostgresTelemetryWorkspacePorts>();
