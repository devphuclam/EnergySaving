...
var t066Failures = await AuditDashboardTests.RunAsync(provider);
Console.WriteLine($"T066: target=127.0.0.1:5433/iump_dev cases={AuditDashboardTests.TestCount}; assertions={AuditDashboardTests.AssertionCount}; failures={t066Failures.Count}");
failures.AddRange(t066Failures);
