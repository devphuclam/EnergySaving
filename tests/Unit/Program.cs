...
var t178Failures = await ConfigurationEndpointTests.Run();
...
var t179Failures = await SimulatorEndpointTests.Run();
...
var t180Failures = await TelemetryQueryEndpointTests.Run();
...
var t057Failures = await LatestSelectionTests.Run();
Console.WriteLine($"T057: cases={LatestSelectionTests.TestCount}; assertions={LatestSelectionTests.AssertionCount}; failures={LatestSelectionTests.FailureCount}");
failures.AddRange(t057Failures);
